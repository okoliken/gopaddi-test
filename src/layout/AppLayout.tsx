...
const AppLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="grid gap-[2.438rem] pb-[2.438rem]">
      <header className="bg-white h-[8.375rem] flex items-center px-[2.5rem]">
        <div className="flex items-center gap-x-[1.75rem]">
          ...
          <fieldset className="relative">
            ...
            <input
              className="bg-background appearance-none outline-none py-[0.75rem] pl-[2.75rem] w-[25rem] rounded-sm placeholder:text-[#647995] placeholder:font-light"
              type="text"
              placeholder="Search"
            />
          </fieldset>
      ...
      <main className="flex items-start container mx-auto gap-x-16">
